...
#import "WADemoLuaAlertView.h"

@interface WADemoLuaAlertView()
...
@property(nonatomic, strong) void (^block)(WADemoLuaAlertViewClicked click);
@end
@implementation WADemoLuaAlertView

- (instancetype)initWithTitle:(NSString *)title message:(NSString *)message cancelButtonTitle:(NSString *)cancelButtonTitle otherButtonTitles:(NSString*)otherButtonTitles block:(void(^)(WADemoLuaAlertViewClicked click))block{
    self = [super init];
    if (self) {
        self.title = title;
...
-(void)clickCancelBtn:(UIButton*)btn{
    if (self.block) {
        self.block(WADemoLuaAlertViewClickedButtonCancel);
    }
...
-(void)clickOtherBtn:(UIButton*)btn{
    if (self.block) {
        self.block(WADemoLuaAlertViewClickedButtonOther);
    }
    [self removeFromSuperview];
}
